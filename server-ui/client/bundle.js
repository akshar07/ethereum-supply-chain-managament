...
var _manafacturer = __webpack_require__(61);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.addNewCar = _this.addNewCar.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'addNewCar',
    value: function addNewCar(_name, _number, _publicAddress, _privateKey) {
      console.log(_name);
      _axios2.default.post('manafacturer/addCar', {
        name: _name,
        no: _number,
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_manafacturer.Manafacturer, { addNewCar: this.addNewCar })
      );
    }
  }]);
...
exports.Manafacturer = undefined;
...
var _cartable = __webpack_require__(64);
...
var Manafacturer = exports.Manafacturer = function (_Component) {
    _inherits(Manafacturer, _Component);

    function Manafacturer(props) {
        _classCallCheck(this, Manafacturer);

        var _this = _possibleConstructorReturn(this, (Manafacturer.__proto__ || Object.getPrototypeOf(Manafacturer)).call(this, props));
        ...
        _this.handleNewCar = _this.handleNewCar.bind(_this);
        _this.handleCarQuery = _this.handleCarQuery.bind(_this);
        _this.getMyCars = _this.getMyCars.bind(_this);

        return _this;
    }

    _createClass(Manafacturer, [{
        key: 'getMyCars',
        value: function getMyCars() {
            var _this2 = this;

            _axios2.default.get('/myCars', {
                params: {
                    address: this.state.publicKey
                }
            }).then(function (cars) {
                _this2.setState({ searchResult: cars.data });
        ...
        value: function getCar() {
            ...
            _axios2.default.get('/manafacturer/getCar', {
                params: {
                    carNumber: this.state.numberQuery
                }
            }).then(function (response) {
                console.log(response);
                _this3.setState({ searchResult: response.data.name }).bind(_this3);
                console.log(_this3.state.searchResult);
            });
        }
    }, {
        key: 'render',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'col-lg-4' },
                        'Public Key: ',
                        _react2.default.createElement('input', { type: 'text', name: 'public', value: this.state.publicKey, onChange: this.handlePublicKeyChange })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-lg-4' },
                        'Private key : ',
                        _react2.default.createElement('input', { type: 'password', name: 'private', value: this.state.privateKey, onChange: this.handlePrivateKeyChange })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'col-lg-4' },
                        'Car Name: ',
                        _react2.default.createElement('input', { type: 'text', name: 'name', value: this.state.carName, onChange: this.handleNameChange })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-lg-4' },
                        'Car Number: ',
                        _react2.default.createElement('input', { type: 'text', name: 'number', value: this.state.carNumber, onChange: this.handleNumberChange })
                    )
                ),
                _react2.default.createElement(
                    'button',
                    { onClick: this.handleNewCar },
                    'Add Car'
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { onClick: this.getMyCars, className: 'myCars' },
                        ' Get My Cars'
                    ),
                    _react2.default.createElement(_cartable.CarTable, { cars: this.state.searchResult })
                )
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./manafacturer.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./manafacturer.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var CarTable = exports.CarTable = function CarTable(props) {
    if (props.cars.length > 0) {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                " Please Enter your Public Address to get your cars!!"
            )
        );
    }
};
